...
public class DoubleArrayTrie {
    ...
    public int build(List<String> key, List<Integer> value) {
        int[] _value = new int[value.size()];
        for(int i=0; i<value.size(); i++) _value[i] = value.get(i);
        return build(key, null, _value, key.size());
    }
